    ...
    <div class="w-70 mr-5">
        <div
            ...
            <div class="text-center px-6 py-2 pt-6">
                <h3 class="semi-bold text-base">Add an Idea</h3>
                <p class="text-xs mt-4">Let us know what u would like and we'll take a look</p>
            </div>
            <form class="space-y-4 px-4 py-6 text-sm" action="" method="POST">
                <div>
                    <input type="text" class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900
                    px-4 py-2" placeholder="your idea">
                </div>
                <div>
                    <select name="category_add" id="category_add"
                            class="w-full border-none bg-gray-100 text-sm rounded-xl px-4 py-2">
